...
\titulo{Estudo analítico e comparativo do portal institucional do IFSP – Novo Padrão x Antigo}
\tipotrabalho{Trabalho de Conclusão de Curso}
\area{Interface Humano-Computador}

\autor{Jeferson Matheus Marques}
\orientador{Prof. Paulo Renato de Oliveira Gavião}
...
\hypersetup{
	...
	pdfcreator={Jeferson Matheus Marques},
